#!/bin/bash
# lib/common.sh -- Shared output and utility functions for gsd-ralph
...
# Args: cmd_name, install_hint, [min_version]
...
# Check all required dependencies for gsd-ralph
# Ralph is a soft dependency (warning only)
# Returns: count of missing hard dependencies
